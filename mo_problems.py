...
def get_problem(name):
    if name == 'zdt1': return zdt1
    if name == 'zdt2': return zdt2
    if name == 'zdt3': return zdt3
    if name == 'zdt4': return zdt4
    if name == 'zdt6': return zdt6
    if name == 'dtlz1': return dtlz1
    if name == 'dtlz2': return dtlz2
    if name == 'dtlz3': return dtlz3
    if name == 'dtlz4': return dtlz4
    if name == 'dtlz5': return dtlz5
    if name == 'dtlz6': return dtlz6
    if name == 'dtlz7': return dtlz7


if __name__ == '__main__':
    problem = get_problem(sys.argv[1])
    xs = [float(e) for e in sys.argv[2:]]
    sys.stdout.write(' '.join([str(e) for e in problem(xs)]))
